...
class MovementControllerTest {
    ...
    void testHandleAddIncomeSuccess() throws Exception {
        ...
        when(mockView.getIncomeDateAsLocalDateTime()).thenReturn(LocalDateTime.of(2026, java.time.Month.JUNE, 15, 10, 0));
    ...
    void testHandleAddExpenseSuccess() throws Exception {
        ...
        when(mockView.getExpenseDateAsLocalDateTime()).thenReturn(LocalDateTime.of(2026, java.time.Month.JUNE, 15, 10, 0));
