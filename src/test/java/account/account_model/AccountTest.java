...
public class AccountTest {
    ...
    void testAddExpenseMovement() {
        ...
        Movement expense = new Movement(2, "Weekly Groceries", expenseAmount, expenseCategory, account,
                LocalDateTime.now());
    ...
    void testAddMixedMovements() {
        ...
        Movement expense = new Movement(2, "Restaurant Bill", expenseAmount, expenseCategory, account,
                LocalDateTime.now());
