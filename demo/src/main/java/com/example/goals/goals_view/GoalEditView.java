...
public class GoalEditView extends JDialog {
    ...
    public GoalEditView(JFrame parent) {
        ...
        add(new JLabel("  Nombre:")); add(txtName);
        add(new JLabel("  Monto Objetivo:")); add(txtTargetAmount);
        add(new JLabel("  Descripción:")); add(txtDescription);
    ...
    public String getDescriptionInput() { return txtDescription.getText().trim(); }
    ...
    public void showDialog() { this.setVisible(true); }
}
